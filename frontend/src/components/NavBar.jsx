        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden sm:flex items-center space-x-4">
              <button onClick={viewLogIn} className="flex items-center text-gray-700 hover:text-blue-600 px-4 py-2 transition-colors">
                <LogIn size={18} className="mr-1" /> Log In
              </button>
              <button onClick={viewSignUp} className="flex items-center bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
          ...
          {menuOpen && (
            <div className="sm:hidden mt-2 space-y-2">
              ...
              <div className="pt-2 border-t border-gray-200 space-y-2">
                <button onClick={viewLogIn} className="flex items-center text-gray-700 hover:text-blue-600 w-full">
                  <LogIn size={18} className="mr-2" /> Log In
                </button>
                <button onClick={viewSignUp} className="flex items-center bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors w-full">
